...
namespace Nop.Web.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<Factories.QuotationModelFactory>().As<Factories.IQuotationModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<Factories.TransactionModelFactory>().As<Factories.ITransactionModelFactory>().InstancePerLifetimeScope();

            //Admin Factory
            builder.RegisterType<TransactionModelFactory>().As<ITransactionModelFactory>().InstancePerLifetimeScope();
