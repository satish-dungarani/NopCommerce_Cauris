...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
        {
            ...
            endpointRouteBuilder.MapControllerRoute("NotificationRedirect",
              pattern + "NotificationRedirect/{entityId:min(0)}/{entityName:min(0)}",
              new { controller = "Transaction", action = "NotificationRedirect" });

            //product attributes with "upload file" type
            endpointRouteBuilder.MapControllerRoute("UploadFileContract",
                pattern + "uploadfilecontract/{transactionId:min(0)}",
                new { controller = "Transaction", action = "UploadFileContract" });
            ...
            //notification
            endpointRouteBuilder.MapControllerRoute("CustomNotification", $"{pattern}notification/",
                new { controller = "Quotation", action = "NotificationList" });
            ...
            endpointRouteBuilder.MapControllerRoute("CustomerChats", $"{pattern}chat/conversations",
            new { controller = "Chat", action = "Conversation" });
            ...
            // quotation
            endpointRouteBuilder.MapControllerRoute("ReceivedQuotes", $"{pattern}Quotation/Received",
           new { controller = "Quotation", action = "Received" });

            endpointRouteBuilder.MapControllerRoute("SendedQuotes", $"{pattern}Quotation/Sended",
            new { controller = "Quotation", action = "Sended" });
            //Request a quotation
            endpointRouteBuilder.MapControllerRoute("RequestQuotation",
                pattern + "requestquotation/{productId:min(0)}",
                new { controller = "Quotation", action = "RequestQuotation" });

            //My Documents
          
            endpointRouteBuilder.MapControllerRoute("MyDocuments", $"{pattern}customer/CustomerDocuments",
               new { controller = "Customer", action = "CustomerDocuments" });

            //Transactions sent
            endpointRouteBuilder.MapControllerRoute("ReceivedTransactions",
                pattern + "transaction/received",
                new { controller = "Transaction", action = "List", isReceived = true});
            
            //Transactions received
            endpointRouteBuilder.MapControllerRoute("SentTransactions",
                pattern + "transaction/sent",
                new { controller = "Transaction", action = "List", isReceived = false });
        }
