...
namespace Nop.Web.Factories
{
    ...
    public partial class ProductModelFactory : IProductModelFactory
    {
            ...
            ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false)
        {
            ...
            model.IsVendor = _workContext.CurrentVendor != null;
            model.VendorId = product.VendorId;
            model.ConnectedId = _workContext.CurrentCustomer.Id;
            model.IsLoggedUser = _customerService.IsRegistered(_workContext.CurrentCustomer);
            if (model.VendorId > 0)
            {
                model.CustomerLinkVendor = _customerService.GetCustomerByVendorId(model.VendorId) != null ? _customerService.GetCustomerByVendorId(model.VendorId).Id : 0;
            }
            //vendor details
            ...
            var price = _priceCalculationService.GetPriceWithCurrentCurrency(_priceCalculationService.GetFinalPrice(product, _workContext.CurrentCustomer, includeDiscounts: false));
            ...
            var quotation = _quotationService.GetByCustomerIdProductId(_workContext.CurrentCustomer.Id, product.Id);
            ...
            model.Quotation = quotationModel;
            return model;
        }
