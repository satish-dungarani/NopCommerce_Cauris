    ...
    public partial class CustomerModelFactory : ICustomerModelFactory
    {
        ...
        public CustomerModelFactory(AddressSettings addressSettings,
            ...
            VendorSettings vendorSettings,
             IQuotationService quotationService, ITransactionService transactionService)
        {
        ...
        public virtual CustomerNavigationModel PrepareCustomerNavigationModel(int selectedTabId = 0)
        {
            ...
            //TO DO : Add AllowCustomerChat to _customerSettings
            //if (_customerSettings.AllowCustomerChat)
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    RouteName = "CustomerChats",
                    Title = _localizationService.GetResource("Messages"),
                    Tab = CustomerNavigationEnum.ChatConversations,
                    ItemClass = "customer-chat-conversations"
                }); 
            }
            if (_workContext.CurrentVendor != null && _quotationService.GetAllByVendorId(_workContext.CurrentVendor.Id).Any())
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    RouteName = "ReceivedQuotes",
                    Title = _localizationService.GetResource("Quotation.Received"),
                    Tab = CustomerNavigationEnum.ReceivedQuotes,
                    ItemClass = "customer-quotes-received"
                });
            }
            if (_quotationService.GetAllByCustomerId(_workContext.CurrentCustomer.Id).Any())
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    RouteName = "SendedQuotes",
                    Title = _localizationService.GetResource("Quotation.Sended"),
                    Tab = CustomerNavigationEnum.SendedQuotes,
                    ItemClass = "customer-quotes-sended"
                });
            }
            ...
            model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
            {
                ...
                Title = _localizationService.GetResource("Customer.MyDocuments"),
                Tab = CustomerNavigationEnum.Documents,
                ItemClass = "customer-mydocuments"
            });



            if (_workContext.CurrentVendor != null && _transactionService.SearchTransactions(vendorId: _workContext.CurrentVendor.Id).Any())
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    RouteName = "ReceivedTransactions",
                    Title = _localizationService.GetResource("Transactions.Received"),
                    Tab = CustomerNavigationEnum.ReceivedTransactions,
                    ItemClass = "customer-transaction-received"
                });
            }
            if (_transactionService.SearchTransactions(customerId: _workContext.CurrentCustomer.Id).Any())
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    RouteName = "SentTransactions",
                    Title = _localizationService.GetResource("Transactions.Sent"),
                    Tab = CustomerNavigationEnum.SentTransactions,
                    ItemClass = "customer-transaction-sent"
                });
            }
