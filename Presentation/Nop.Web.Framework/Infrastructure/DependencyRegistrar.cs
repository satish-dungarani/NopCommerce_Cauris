...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<ConversationService>().As<IConversationsService>().InstancePerLifetimeScope();
            builder.RegisterType<ConversationMessageService>().As<IConversationMessagesService>().InstancePerLifetimeScope();
            builder.RegisterType<CustomerConnectionService>().As<ICustomerConnectionService>().InstancePerLifetimeScope();
            ...
            //Fees
            builder.RegisterType<FeesService>().As<IFeesService>().InstancePerLifetimeScope();

            //Transaction 
            builder.RegisterType<TransactionService>().As<ITransactionService>().InstancePerLifetimeScope();

            //Notification
            builder.RegisterType<CustomNotificationService>().As<ICustomNotificationService>().InstancePerLifetimeScope();
