...
namespace Nop.Services.Tests.Catalog
{
    ...
    public class PriceCalculationServiceTests : ServiceTest
    {
        ...
        private Mock<IRepository<Fees>> _feesRepository;
        ...
        public new void SetUp()
        {
            ...
            _feesRepository = new Mock<IRepository<Fees>>();
            _feesRepository.Setup(t => t.Table).Returns(GetMockFees);
            ...
            _feesService = new FeesService(_feesRepository.Object, _eventPublisher.Object);
            ...
            _priceCalcService = new PriceCalculationService(_catalogSettings,
                ...
                _productService, _staticCacheManager, _storeContext.Object, _workContext.Object, _feesService);
        ...
        private IQueryable<Fees> GetMockFees()
        {
        ...
        [Test]
        public void Can_get_final_product_price_with_fees()
        {
            RunWithTestServiceProvider(() =>
            {
                var product = _productService.GetProductById(1);
                ...
                var unityPrice = _priceCalcService.GetFinalPrice(product, customer, 0, false);

                unityPrice.Should().Be(12.34M);
                _priceCalcService.GetPriceWithFees(unityPrice).Should().Be(14.19M);
            });
        }
        #endregion
    }
