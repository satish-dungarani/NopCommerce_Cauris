...
namespace Nop.Data.Migrations
{
    ...
    public class SchemaMigration : AutoReversingMigration
    {
        ...
        public override void Up()
        {
            ...
            _migrationManager.BuildTable<Conversation>(Create);
            _migrationManager.BuildTable<ConversationMessage>(Create);
            _migrationManager.BuildTable<CustomerConnection>(Create);
