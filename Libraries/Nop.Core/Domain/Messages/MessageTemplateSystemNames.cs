namespace Nop.Core.Domain.Messages
{
    ...
    public static partial class MessageTemplateSystemNames
    {
        ...
        /// <summary>
        /// Request quote customer notification
        /// </summary>
        public const string RequestQuoteCustomerNotification = "Quote.Request.CustomerNotification";

        /// <summary>
        /// Request quote vendor notification
        /// </summary>
        public const string RequestQuoteVendorNotification = "Quote.Request.VendorNotification";

        /// <summary>
        /// Response quote customer notification
        /// </summary>
        public const string ResponseQuoteCustomerNotification = "Quote.Response.CustomerNotification";

        /// <summary>
        /// Accept quote customer notification
        /// </summary>
        public const string AcceptQuoteCustomerNotification = "Quote.Accept.CustomerNotification";

        /// <summary>
        /// Accept quote vendor notification
        /// </summary>
        public const string AcceptQuoteVendorNotification = "Quote.Accept.VendorNotification";

        #endregion

        #region Custom code transaction

        /// <summary>
        /// Seller upload contract
        /// </summary>
        public const string SellerUploadContract = "Trans.Upload.Contract";

        /// <summary>
        /// Moderator update contract
        /// </summary>
        public const string ModeratorValidateContract = "Trans.Validate.Contract";

        /// <summary>
        /// Moderator ask for clarification
        /// </summary>
        public const string ModeratorClarificationContract = "Trans.clarification.Contract";
