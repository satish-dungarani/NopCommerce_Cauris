...
namespace Nop.Services.Messages
{
    ...
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        /// <param name="languageId">Language identifier</param>
        /// <param name="vendorId">Vendor identifier</param>
        public void AddQuoteTokens(IList<Token> tokens, QuotationMessage quotation, int languageId, int vendorId = 0)
        {
            tokens.Add(new Token("Quotation.QuotationNumber", quotation.QuotationNumber));
            tokens.Add(new Token("Quotation.CustomerFullName", quotation.CustomerFullName));
            tokens.Add(new Token("Quotation.VendorFullName", quotation.VendorFullName));
            tokens.Add(new Token("Quotation.ProductTitle", quotation.ProductTitle));
            tokens.Add(new Token("Quotation.Price", quotation.Price));


            _eventPublisher.EntityTokensAdded(quotation, tokens);
        }
