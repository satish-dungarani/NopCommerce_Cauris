...
namespace Nop.Services.Messages
{
    ...
    public partial class WorkflowMessageService : IWorkflowMessageService
    {
        ...
        #region Quotation workflow

        /// <summary>
        /// Send request quote customer notification
        /// </summary>
        /// <param name="quotation">quotation instance</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public IList<int> SendRequestQuoteCustomerNotification(QuotationMessage quotation, int languageId)
        {
            if (quotation == null)
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.RequestQuoteCustomerNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();

            //tokens
            var commonTokens = new List<Token>();
            _messageTokenProvider.AddQuoteTokens(commonTokens, quotation, languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public IList<int> SendRequestQuoteVendorNotification(QuotationMessage quotation, int languageId)
        {
            if (quotation == null)
                throw new ArgumentNullException(nameof(quotation));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.RequestQuoteVendorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        /// <summary>
        /// Send response quote customer notification
        /// </summary>
        /// <param name="quotation">quotation instance</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public IList<int> SendResponseQuoteCustomerNotification(QuotationMessage quotation, int languageId)
        {
            if (quotation == null)
                throw new ArgumentNullException(nameof(quotation));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.ResponseQuoteCustomerNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public IList<int> SendAcceptQuoteCustomerNotification(QuotationMessage quotation, int languageId)
        {
            if (quotation == null)
                throw new ArgumentNullException(nameof(quotation));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.AcceptQuoteCustomerNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public IList<int> SendAcceptQuoteVendorNotification(QuotationMessage quotation, int languageId)
        {
            if (quotation == null)
                throw new ArgumentNullException(nameof(quotation));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.AcceptQuoteVendorNotification, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        /// <summary>
        /// Send seller upload contract notification
        /// </summary>
        /// <param name="customer">customer(Vendor)</param>
        /// <param name="transactionId">Transaction identifier</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public IList<int> SellerUploadContractNotification(Customer customer, int transactionId, int receiverId, int languageId)
        {
            if (customer == null)
                throw new ArgumentNullException(nameof(customer));

            var reciever = _customerService.GetCustomerById(receiverId);
            if (reciever == null)
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.SellerUploadContract, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();

            //tokens
            var commonTokens = new List<Token>();
            commonTokens.Add(new Token("Vendor.Name", _customerService.GetCustomerFullName(customer)));
            commonTokens.Add(new Token("Transaction.Id", transactionId));
            ...
            return messageTemplates.Select(messageTemplate =>
            {
                ...
                var toEmail = reciever.Email;
                var toName = reciever.Email;
        ...
        /// <summary>
        /// Send moderator validate contract notification
        /// </summary>
        /// <param name="customer">customer</param>
        /// <param name="transactionId">Transaction identifier</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public IList<int> ModeratorValidateContractNotification(int transactionId, int receiverId, int languageId)
        {
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.ModeratorValidateContract, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
        ...
        /// <summary>
        /// Send moderator clarification contract notification
        /// </summary>
        /// <param name="receiverId">customer Id</param>
        /// <param name="transactionId">Transaction identifier</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        public IList<int> ModeratorClarificationContractNotification(int transactionId, int receiverId, int languageId)
        {
            var reciever = _customerService.GetCustomerById(receiverId);
            if (reciever == null)
                throw new ArgumentNullException(nameof(reciever));
            ...
            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.ModeratorClarificationContract, store.Id);
            if (!messageTemplates.Any())
                return new List<int>();
