...
namespace Nop.Services.Messages
{
    ...
    public partial interface IWorkflowMessageService
    {
        ...
        /// </summary>
        /// <param name="customer">quotation instance</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendRequestQuoteCustomerNotification(QuotationMessage quotation, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendRequestQuoteVendorNotification(QuotationMessage quotation, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendResponseQuoteCustomerNotification(QuotationMessage quotation, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendAcceptQuoteCustomerNotification(QuotationMessage quotation, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendAcceptQuoteVendorNotification(QuotationMessage quotation, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SellerUploadContractNotification(Customer customer,int transactionId, int receiverId ,int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> ModeratorValidateContractNotification(int transactionId, int receiverId, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> ModeratorClarificationContractNotification(int transactionId, int receiverId, int languageId);
