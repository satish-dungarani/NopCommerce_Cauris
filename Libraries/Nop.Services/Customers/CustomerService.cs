...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        /// <summary>
        /// Gets a customer by vendor Id (in case of many customer for a on vendor return the first)
        /// TODO : check 
        /// </summary>
        ...
        public virtual Customer GetCustomerByVendorId(int vendorId)
        {
            ...
            return _customerRepository.Table.FirstOrDefault(c => c.VendorId == vendorId);
        }
        ...
        /// <summary>
        /// Get Customer Documents items
        /// </summary>
        /// <param name="customer"></param>
        /// <param name="storeId"></param>
        /// <returns></returns>
        //public virtual IList<CustomerDocumentItem> GetCustomerDocuments(Customer customer, int storeId = 0)
        //{
        //    return new List<CustomerDocumentItem>();
        //}
        #endregion
