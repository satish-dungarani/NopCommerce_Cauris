...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerRegistrationService : ICustomerRegistrationService
    {
        ...
        /// <summary>
        /// Insert password on activation
        /// </summary>
        /// <param name="customer"></param>
        /// <param name="password"></param>
        /// <param name="passwordFormat"></param>
        public virtual void InsertPassword(Customer customer, string password, PasswordFormat passwordFormat)
        {
            var customerPassword = new CustomerPassword
            {
        ...
        public virtual ChangePasswordResult SetPasswordAfterActivation(ChangePasswordRequest request)
        {
            if (request == null)
                throw new ArgumentNullException(nameof(request));
