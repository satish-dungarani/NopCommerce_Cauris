...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManageCaurisTransaction = new PermissionRecord { Name = "Admin Area.Manage Cauris Transaction", SystemName = "ManageCaurisTransaction", Category = "Cauris" };
