...
namespace Nop.Services.Catalog
{
    ...
    public partial class PriceCalculationService : IPriceCalculationService
    {
        ...
        /// <summary>
        /// Calculate price of product with fees
        /// </summary>
        /// <param name="unityPrice">unity price</param>
        /// <param name="quantity">quantite </param>
        /// <returns></returns>
        public decimal GetPriceWithFees(decimal unityPrice, float quantity = 1)
        {
            decimal sumFees = _feesService.GetAll().Sum(x => x.Percent);
            return Math.Round(unityPrice * (decimal)quantity * (1 + sumFees / 100), 2);
        }
        ...
        /// <returns></returns>
        public decimal GetPriceWithCurrentCurrency(decimal price)
        {
